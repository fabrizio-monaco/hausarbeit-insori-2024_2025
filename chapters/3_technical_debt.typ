...
Martin Fowler erweiterte das Konzept dieser Unterscheidung und erstellte damit den "Technischen Schuldenquadranten" @fig:techdebtquadrant \ Dieser Quadrant klassifiziert technische Schulden anhand von zwei Dimensionen: *Rücksichtslos* und *Umsichtig*. Dadurch entstehen vier Kategorien:
#figure(
...
Ein weiterer Faktor für das Entstehen technischer Schulden ist mangelnde Erfahrung oder unzureichendes Wissen der Entwickler #ccite("WhatisTe71:online"). Insbesondere unerfahrene Entwickler neigen dazu, Code zu schreiben, der nicht den Best Practices entspricht und daher schwer zu warten ist. Auch ein unzureichendes Verständnis von Architekturmuster oder Designprinzipien innerhalb einer Codebasis kann zu technischen Schulden führen. Darüber hinaus tragen unzureichende Planung und mangelnde Kommunikation im Team ebenfalls zur Entstehung technischer Schulden bei #ccite("WhatisTe71:online"). \ 
Unklar definierte oder sich häufig ändernde Anforderungen führen oft zu Ad-hoc-Lösungen und Workarounds, die den Code unnötig komplex machen und die Wartbarkeit erheblich erschweren. Zusätzlich können unzureichende Tests sowie das Versäumnis, den Code regelmäßig einem Refactoring #gls("refactoring") zu unterziehen, dazu beitragen, dass sich technische Schulden im Laufe der Zeit weiter anhäufen. \
