...
#let abstractDE(title: "Zusammenfassung", layoutConfig: none) = {
  ...
  v(1em)
  text()[
    Die vorliegende Arbeit untersucht die sozialen und organisatorischen Konsequenzen der langfristigen Anhäufung von technischen Schulden in Softwareunternehmen. \ Technische Schulden entstehen durch Kompromisse in der Softwareentwicklung und können sich zu einem unüberwindbaren Hindernis entwickeln, das die Motivation und Zusammenarbeit im Team beeinträchtigt.\
